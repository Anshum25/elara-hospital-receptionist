...
class Settings:
    ...
    HEYGEN_AVATAR_ID: str = os.getenv("HEYGEN_AVATAR_ID", "Anna_public_3_20240108")
    HEYGEN_VOICE_ID: str = os.getenv("HEYGEN_VOICE_ID", "en-US-JennyNeural")
    ...
    # D-ID for real-time WebRTC streaming
